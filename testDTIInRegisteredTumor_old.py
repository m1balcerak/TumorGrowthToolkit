...
#%%
tissue = nib.load("/mnt/8tb_slot8/jonas/datasets/TGM/rgbResults/sub-tgm042_ses-preop_space-sri_dti_RGB.nii.gz").get_fdata()
print('shape: (x, y, z, fa-diffusion) :', tissue.shape)

seg = nib.load("/mnt/8tb_slot8/jonas/datasets/TGM/tgm/tgm042/preop/sub-tgm042_ses-preop_space-sri_seg.nii.gz").get_fdata()

brainTissue = nib.load("/mnt/8tb_slot8/jonas/datasets/TGM/tgm/tgm042/preop/sub-tgm042_ses-preop_space-sri_tissuemask.nii.gz").get_fdata()
...
tissueTensorRegistered = nib.load("/mnt/8tb_slot8/jonas/workingDirDatasets/tgm/registerDTIAtlasToPatient/tgm042/tensors.nii.gz").get_fdata()[:,:,:,0,:]


#tissueTensorRegistered = nib.load("/mnt/8tb_slot8/jonas/workingDirDatasets/HCPprob/DTIAtlas/FSL_HCP1065_tensor_1mm_space-HPC-AntsIndexSpace.nii.gz").get_fdata()[:,:,:,0,:]

#tissueTensorRegistered = nib.load("/mnt/8tb_slot8/jonas/datasets/HCPprob/DTIAtlas/FSL_HCP1065_tensor_1mm.nii.gz").get_fdata()#[:,:,:,0,:]
...
path = "/mnt/8tb_slot8/jonas/workingDirDatasets/tgm/dtiFirstTests/tgm042/"
